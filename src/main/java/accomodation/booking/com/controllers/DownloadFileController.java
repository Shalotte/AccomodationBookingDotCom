...
import accomodation.booking.com.entities.View;
import accomodation.booking.com.repositories.FileRepository;
...
public ResponseEntity<List<String>> getListFiles() {
	...
	return  (ResponseEntity<List<String>>) fileRepository.findAll();
